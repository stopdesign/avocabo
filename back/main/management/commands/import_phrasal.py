...
p_verbs = [
    'back away', 'back off', 'be back', 'be off', 'be out', 'be over', 'be up', 'be up to', 'blow out', 'blow up',
    'break down', 'break in', 'break into', 'break off', 'break out', 'break up', 'burst out', 'call back', 'calm down',
    'carry on', 'carry out', 'catch up', 'check in', 'check out', 'clean up', 'come across', 'come along', 'come back',
    'come by', 'come down', 'come forward', 'come from', 'come in', 'come off', 'come on', 'come out', 'come over',
    'come up', 'count on', 'cut off', 'cut out', 'end up', 'fall down', 'fall off', 'figure out', 'find out',
    'get along', 'get around', 'get away', 'get back', 'get down', 'get in', 'get off', 'get along', 'get out',
    'get over',
    'get through', 'get up', 'give up', 'go along', 'go around', 'go away', 'go back', 'go by', 'go down', 'go in',
    'go off', 'go on', 'go out', 'go over', 'go through', 'go up', 'grow up', 'hang around', 'hang on', 'hang up',
    'help out', 'hold on', 'hold out', 'hold up', 'keep on', 'keep up', 'knock down', 'knock off', 'knock out',
    'let in', 'let out', 'lie down', 'line up', 'look back', 'look down', 'look for', 'look forward to', 'look out',
    'look over', 'make out', 'make up', 'move in', 'move on', 'move out', 'pass out', 'pick up', 'point out',
    'pull away', 'pull off', 'pull on', 'pull out', 'pull up', 'put away', 'put down', 'put in', 'put on', 'put out',
    'put up', 'run away', 'run into', 'run off', 'run out', 'run over', 'set down', 'set off', 'set up', 'settle down',
    'shoot out', 'show up', 'shut down', 'shut up', 'sit back', 'sit down', 'sit up', 'spread out', 'stand by',
    'stand out', 'stand up', 'stick out', 'switch off', 'switch on', 'take away', 'take back', 'take in', 'take off',
    'take on', 'take out', 'take over', 'take up', 'throw up', 'turn around', 'turn away', 'turn back', 'turn down',
    'turn into', 'turn off', 'turn on', 'turn out', 'turn over', 'turn up', 'wake up', 'walk around', 'walk away',
    'walk back', 'walk in', 'walk off', 'walk out', 'walk over', 'walk up', 'watch out', 'wind up', 'work out',
    'work up', 'write down'
]

p2_verbs = [
    'put up with', 'work at', 'send off', 'rub into', 'come down with', 'stay out', 'come round', 'put aside',
    'look through', 'pass around', 'stay over', 'go for', 'stick together', 'talk into', 'face up to',
    'be taken in', 'deal with', 'call in', 'run down', 'look up to', 'look forward to', 'go down with', 'mix with',
    'stand for', 'build up', 'see to', 'rub on', 'fall through', 'stand up for', 'look at', 'stay on', 'head for',
    'bring out', 'knock over', 'rub out', 'turn to', 'let off', 'be carried away', 'keep off', 'live with', 'stop over',
    'take out', 'stick with', 'come up against', 'catch on', 'stand back', 'get away', 'get away from', 'think through',
    'make up for', 'run on', 'wear out', 'come up with', 'live up to', 'break through', 'get at', 'lock in',
    'pull down', 'live for', 'call on', 'set out', 'put through', 'miss out on', 'keep away', 'make into', 'check on',
    'get round to', 'do away with', 'work on', 'clear away', 'leave out', 'see through', 'do without', 'fit in',
    'fit in with', 'live on', 'stand up to', 'catch up with', 'clear up', 'throw out', 'write up', 'stay away from',
    'cut across', 'get away with', 'get into', 'set back', 'get down to', 'come to', 'stay up', 'burst in',
    'get on with', 'pull in', 'see off', 'keep up with', 'make for', 'pull over', 'take down', 'pay off', 'care for',
    'keep down', 'fall for', 'look on', 'take to', 'lock out', 'pick on', 'draw up', 'talk over', 'get out of',
    'keep back'
]

p3_verbs = [
    'doze off', 'nod off', 'rip off', 'finish off', 'show off', 'tell off',
